...
namespace Microsoft.Azure.SpatialAnchors.Unity.Examples
{
    public abstract class DemoScriptBase : InputInteractionBase
    {
        ...
        protected override void OnTouchInteraction(Touch[] touches)
        {
            ...
            SwipeTouchInteractionHelper(touches[0]);
        }

        private void SwipeTouchInteractionHelper(Touch touch)
        {
        ...
        /// </summary>
        protected virtual async Task SaveCurrentObjectAnchorToCloudAsync(GameObject anchoredObject = null)
        {
            ...
            cloudAnchor.Expiration = DateTimeOffset.Now.AddYears(10);
