...
namespace Microsoft.Azure.SpatialAnchors.Unity.Examples
{
    public abstract class FirebaseManager : MonoBehaviour
    {
        ...
        protected static readonly Dictionary<string, ModelData> spawnedObjects = new Dictionary<string, ModelData>();
        ...
        public Dictionary<string, ModelData> SpawnedObjects => spawnedObjects;
        ...
        public class ModelData
        {
            ...
            public ModelData(GameObject obj, Vector3 positionOffset, Quaternion rotationOffset, Vector3 scale)
            {
                this.obj = obj;
