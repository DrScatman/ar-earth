...
namespace Microsoft.Azure.SpatialAnchors.Unity.Examples
{
    public abstract class InputInteractionBase : MonoBehaviour
    {
        ...
        protected virtual void OnTouchInteraction(Touch[] touches)
        {
            if (touches[0].phase == TouchPhase.Ended) //check if the finger is removed from the screen
            {
                OnTouchInteractionEnded(touches[0]);
            }
        }
